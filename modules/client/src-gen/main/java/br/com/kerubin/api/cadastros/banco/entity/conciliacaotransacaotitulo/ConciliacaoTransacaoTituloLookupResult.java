...
public class ConciliacaoTransacaoTituloLookupResult {
	...
	public ConciliacaoTransacaoTituloLookupResult() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConciliacaoTransacaoTituloLookupResult other = (ConciliacaoTransacaoTituloLookupResult) obj;
		if (id == null) {
			if (other.id != null)
				return false;
